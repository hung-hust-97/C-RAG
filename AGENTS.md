...
- Place all agent-generated summary reports, analysis documents, utility scripts, and test files in the `.kiro/` directory: use `.kiro/reports/` for summaries and documentation, `.kiro/scripts/` for utility scripts, and organize test files appropriately within `.kiro/`.
