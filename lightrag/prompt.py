...
PROMPTS["fail_response"] = "Hiện tại tôi chưa có đủ dữ liệu để trả lời chính xác câu hỏi này. Vui lòng cung cấp thêm bối cảnh, từ khóa, hoặc tài liệu liên quan để tôi có thể hỗ trợ đầy đủ hơn.[no-context]"
